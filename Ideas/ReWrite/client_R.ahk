...
createGUI(){
	...
	Gui, Code:Add, Button, x360 y510 w70 h30 HwndBSub gCodeSubmit, Submit
...
WS_OnRead(socket){
	...
	msgType := arg1
	;//mb(arg1,arg2,arg3,arg4)
	Gui,Main:Default
	SB_SetText(ServerMessage , 4)
	DBSVRMSG .= ServerMessage . "`n"
	GuiControl, DBG:, Edit1, %DBSVRMSG%
	setChatLog(EChLog, arg1, arg2, arg3, arg4, arg5)
}

setChatLog(hwn, a, b, c, d, e){
	global CLIENTNICK, CURRENTCHAN, CLIENTCHANS, ALLCHANLOGS, CODE, cd
	Gui, Code:Default
